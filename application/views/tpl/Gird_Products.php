...
<body class="page-products catalog-category-view page-layout-1column ">
                    ...
                    <div class="col-md-12 col-main">
                        ...
                        <div class=" toolbar-products toolbar-top">
                            ...
                            <div class="modes">
                                ...
                                <a class="modes-mode mode-list" title="List" href="List_Products.html" id="mode-list">
                            ...
                            <div class="toolbar-limiter toolbar-option">
                            ...
                            <div class="toolbar-color toolbar-option">
                                <label class="label" >Color:</label>
                                <select  class="color-options form-control">
                                    <option value="position" selected="selected">All</option>
                                    <option value="name">Red</option>
                                    <option value="price">Blue</option>
                                </select>
                            </div><!-- Color by -->

                            <div class="toolbar-price toolbar-option">
                                <label class="label" >Price:</label>
                                <select  class="price-options form-control">
                                    <option value="position" selected="selected">All </option>
                                    <option value="name">$100 - $200</option>
                                    <option value="price">$200 - $400</option>
                                </select>
                            </div><!-- Price by -->
