...
<body class="page-product-configurable catalog-product-view page-layout-1column">
        ...
        <div id="main" class="site-main">
            ...
            <div class="columns container">
                ...
                <div class="row portfolio-detail">
                    ...
                    <div class="col-sm-4 col-sm-3 portfolio-info">
                        <ul>
                            <li>
                                <b>date:    </b><span>november 12, 2015</span>
                            </li>
                            <li>
                                <b>categories:       </b><span>fashion</span>
                            </li>
                            <li>
                                <b>Client:       </b><span>sony, apple </span>
                            </li>
                            <li>
                                <b>location:       </b><span>japan</span>
                            </li>
                            <li>
                                <b>Share: </b>
                                <a href="" class="link"><i aria-hidden="true" class="fa fa-facebook"></i></a>
                                <a href="" class="link"><i aria-hidden="true" class="fa fa-tumblr"></i></a>
                                <a href="" class="link"><i aria-hidden="true" class="fa fa-linkedin"></i></a>
                                <a href="" class="link"><i aria-hidden="true" class="fa fa-rss"></i></a>
                                <a href="" class="link"><i aria-hidden="true" class="fa fa-dribbble"></i></a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-sm-8 col-sm-9">
                        <div class="actions clearfix">
                            <a href="" class="action action-prew pull-left"><i class="fa fa-caret-left" aria-hidden="true"></i>Previous</a>
                            <a href="" class="action action-next pull-right">Next<i class="fa fa-caret-right" aria-hidden="true"></i></a>
                ...
                <div class="block-products products-grid  style4 block-related">
                    ...
                    <div class="block-content  ">
                        ...
                        <div class="product-items portfolio-list owl-carousel nav-top-right nav-border" data-nav="true" data-dots="false" data-margin="30" data-responsive='{"0":{"items":1},"480":{"items":2},"600":{"items":3},"992":{"items":3}}'>
                            <div class="item">
                                <div class="item-info">
                                    <div class="item-head">
                                        <img alt="" src="images/media/portfolio3.jpg">
                                        <div class="item-actions">
                                            <a href="" class="action"><i class="fa fa-search" aria-hidden="true"></i></a>
                                            <a href="" class="action"><i class="fa fa-link" aria-hidden="true"></i></a>
                                        </div>
                                    </div>
                                    <div class="item-detail">
                                        <a href="" class="item-category">Fashion, Design</a>
                                        <a href="" class="item-name">Project For Summer</a>
                                    </div>
                                </div>
                            </div>
                            <div class="item">
                                <div class="item-info">
                                    <div class="item-head">
                                        <img alt="" src="images/media/portfolio2.jpg">
                                        <div class="item-actions">
                                            <a href="" class="action"><i class="fa fa-search" aria-hidden="true"></i></a>
                                            <a href="" class="action"><i class="fa fa-link" aria-hidden="true"></i></a>
                                        </div>
                            ...
                            <div class="item">
                                <div class="item-info">
                                    <div class="item-head">
                                        <img alt="" src="images/media/portfolio1.jpg">
                                        <div class="item-actions">
                                            <a href="" class="action"><i class="fa fa-search" aria-hidden="true"></i></a>
                                            <a href="" class="action"><i class="fa fa-link" aria-hidden="true"></i></a>
                                        </div>
                            ...
                            <div class="item">
                                <div class="item-info">
                                    <div class="item-head">
                                        <img alt="" src="images/media/portfolio4.jpg">
                                        <div class="item-actions">
                                            <a href="" class="action"><i class="fa fa-search" aria-hidden="true"></i></a>
                                            <a href="" class="action"><i class="fa fa-link" aria-hidden="true"></i></a>
                                        </div>
