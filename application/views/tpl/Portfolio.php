            ...
            <div class="columns container">
                    ...
                    <div class="block-portfolio">
                        ...
                        <ul class="nav nav-pills" role="tablist">
                            <li role="presentation" class="active"><a href="#tab1"  role="tab" data-toggle="tab">all works</a></li>
                            <li role="presentation"><a href="#tab2"  role="tab" data-toggle="tab">entertainment</a></li>
                            <li role="presentation"><a href="#tab3"  role="tab" data-toggle="tab">women style</a></li>
                            <li role="presentation"><a href="#tab4"  role="tab" data-toggle="tab">new products</a></li>
                        </ul>
                            ...
                            <div role="tabpanel" class="tab-pane active" id="tab1">
                                ...
                                <div class="portfolio-list row">
                                    ...
                                    <div class="col-sm-4 item">
                                        <div class="item-info">
                                            <div class="item-head">
                                                <img alt="" src="images/media/portfolio5.jpg">
                                                <div class="item-actions">
                                                    <a href="" class="action"><i class="fa fa-search" aria-hidden="true"></i></a>
                                                    <a href="" class="action"><i class="fa fa-link" aria-hidden="true"></i></a>
                                                </div>
                                    ...
                                    <div class="col-sm-4 item">
                                        <div class="item-info">
                                            <div class="item-head">
                                                <img alt="" src="images/media/portfolio6.jpg">
                                                <div class="item-actions">
                                                    <a href="" class="action"><i class="fa fa-search" aria-hidden="true"></i></a>
                                                    <a href="" class="action"><i class="fa fa-link" aria-hidden="true"></i></a>
                                                </div>
                                    ...
                                    <div class="col-sm-4 item">
                                        <div class="item-info">
                                            <div class="item-head">
                                                <img alt="" src="images/media/portfolio7.jpg">
                                                <div class="item-actions">
                                                    <a href="" class="action"><i class="fa fa-search" aria-hidden="true"></i></a>
                                                    <a href="" class="action"><i class="fa fa-link" aria-hidden="true"></i></a>
                                                </div>
                                    ...
                                    <div class="col-sm-4 item">
                                        <div class="item-info">
                                            <div class="item-head">
                                                <img alt="" src="images/media/portfolio8.jpg">
                                                <div class="item-actions">
                                                    <a href="" class="action"><i class="fa fa-search" aria-hidden="true"></i></a>
                                                    <a href="" class="action"><i class="fa fa-link" aria-hidden="true"></i></a>
                                                </div>
                                    ...
                                    <div class="col-sm-4 item">
                                        <div class="item-info">
                                            <div class="item-head">
                                                <img alt="" src="images/media/portfolio9.jpg">
                                                <div class="item-actions">
                                                    <a href="" class="action"><i class="fa fa-search" aria-hidden="true"></i></a>
                                                    <a href="" class="action"><i class="fa fa-link" aria-hidden="true"></i></a>
                                                </div>
